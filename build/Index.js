...
/******/ 	__webpack_require__.p = "/Users/maheshk/Developer/snake/build/";
/******/
...
var DomTypesRe = __webpack_require__(3);
var EventTargetRe = __webpack_require__(4);
...
function unsafelyUnwrapOption(t) {
  if (t) {
    return t[0];
  } else {
    throw [
...
var Option = /* module */[
  /* map */map,
  /* unsafelyUnwrapOption */unsafelyUnwrapOption,
  /* andThen */andThen
];
...
var Curry = __webpack_require__(1);
var Caml_obj = __webpack_require__(25);
...
var Caml_string = __webpack_require__(30);
var Caml_exceptions = __webpack_require__(31);
var Caml_missing_polyfill = __webpack_require__(32);
var Caml_builtin_exceptions = __webpack_require__(0);
var CamlinternalFormatBasics = __webpack_require__(33);
...
var create = Cell$SnakeGame.create;
...
var Pervasives = __webpack_require__(13);
var Cell$SnakeGame = __webpack_require__(6);
var Food$SnakeGame = __webpack_require__(16);

function gainWeight(tail) {
  var oldTail = List.rev(tail);
  var oldTailEnd = List.hd(oldTail);
  var newTailEnd = Cell$SnakeGame.create(/* tuple */[
        Cell$SnakeGame.x(oldTailEnd) + 1 | 0,
        Cell$SnakeGame.y(oldTailEnd)
      ]);
  return /* :: */[
          newTailEnd,
          /* [] */0
...
function move(snake, direction, food) {
  var head = List.hd(snake);
  var newTail = List.rev(List.tl(List.rev(snake)));
  var foodCell = Food$SnakeGame.position(food);
  var match = Caml_obj.caml_equal(head, foodCell);
  var newTailEnd = match !== 0 ? gainWeight(newTail) : /* [] */0;
  var newHead;
  switch (direction) {
    case 0 : 
  ...
  return Pervasives.$at(/* :: */[
              newHead,
              /* [] */0
            ], Pervasives.$at(newTail, newTailEnd));
}
...
var List = __webpack_require__(10);
var Caml_obj = __webpack_require__(25);
var DocumentRe = __webpack_require__(19);
var Js_primitive = __webpack_require__(2);
var Ext$SnakeGame = __webpack_require__(9);
var Key$SnakeGame = __webpack_require__(23);
var Draw$SnakeGame = __webpack_require__(24);
var Food$SnakeGame = __webpack_require__(16);
var Snake$SnakeGame = __webpack_require__(17);
var World$SnakeGame = __webpack_require__(39);

var documentEventTarget = Ext$SnakeGame.Option[/* unsafelyUnwrapOption */1](Ext$SnakeGame.Option[/* andThen */2]((function (prim) {
...
function handleTick() {
  ...
  var match = Caml_obj.caml_equal(Food$SnakeGame.position(oldWorld[/* food */2]), List.hd(Snake$SnakeGame.body(oldWorld[/* snake */1])));
  var newWorld_000 = /* canvasContext */oldWorld[/* canvasContext */0];
  var newWorld_001 = /* snake */Snake$SnakeGame.move(oldWorld[/* snake */1], oldWorld[/* direction */3], oldWorld[/* food */2]);
  var newWorld_002 = /* food */match !== 0 ? Food$SnakeGame.newFood(/* () */0) : oldWorld[/* food */2];
  var newWorld_003 = /* direction */oldWorld[/* direction */3];
  var newWorld = /* record */[
    newWorld_000,
    newWorld_001,
    newWorld_002,
  ...
  Draw$SnakeGame.drawSnake(state[0][/* snake */1]);
  return Draw$SnakeGame.drawFood(state[0][/* food */2]);
}
...
function handleEvent(evt) {
  var oldWorld = state[0];
  var parsedKey = Key$SnakeGame.parseKey(evt.key);
  var newDirection = Key$SnakeGame.getDirection(parsedKey, oldWorld[/* direction */3]);
...
var Curry = __webpack_require__(1);
var NodeRe = __webpack_require__(7);
var DomTypesRe = __webpack_require__(3);
var Js_primitive = __webpack_require__(2);
var ParentNodeRe = __webpack_require__(8);
var EventTargetRe = __webpack_require__(4);
var DocumentOrShadowRootRe = __webpack_require__(21);
var NonElementParentNodeRe = __webpack_require__(22);
...
var List = __webpack_require__(10);
var ElementRe = __webpack_require__(34);
var Caml_int32 = __webpack_require__(5);
var Canvas2dRe = __webpack_require__(38);
var Js_primitive = __webpack_require__(2);
var Ext$SnakeGame = __webpack_require__(9);
var Cell$SnakeGame = __webpack_require__(6);
var Food$SnakeGame = __webpack_require__(16);
...
var canvasEl = Ext$SnakeGame.Option[/* unsafelyUnwrapOption */1](Js_primitive.null_undefined_to_opt(document.getElementById("snake-game")));

var ctx = canvasEl.getContext("2d");

function drawCell(fillColor, cell) {
  Canvas2dRe.setFillStyle(ctx, /* String */0, fillColor);
  Canvas2dRe.setStrokeStyle(ctx, /* String */0, "white");
  ctx.fillRect(Caml_int32.imul(Cell$SnakeGame.x(cell), 10), Caml_int32.imul(Cell$SnakeGame.y(cell), 10), 10.0, 10);
  ctx.strokeRect(Caml_int32.imul(Cell$SnakeGame.x(cell), 10), Caml_int32.imul(Cell$SnakeGame.y(cell), 10), 10, 10);
  return /* () */0;
}
...
function drawSnake(snake) {
  return List.iter(drawSnakeCell, Snake$SnakeGame.body(snake));
}

function drawFoodCell(cell) {
  return drawCell("#af2010", cell);
}

function drawFood(food) {
  return drawCell("#af2010", Food$SnakeGame.position(food));
}

var canvasWidth = Ext$SnakeGame.Option[/* unsafelyUnwrapOption */1](Ext$SnakeGame.Option[/* map */0]((function (prim) {
            return prim.offsetWidth;
          }), ElementRe.asHtmlElement(canvasEl)));

var canvasHeight = Ext$SnakeGame.Option[/* unsafelyUnwrapOption */1](Ext$SnakeGame.Option[/* map */0]((function (prim) {
...
var Caml_primitive = __webpack_require__(12);
var Caml_builtin_exceptions = __webpack_require__(0);
...
var NodeRe = __webpack_require__(7);
var DomTypesRe = __webpack_require__(3);
var SlotableRe = __webpack_require__(35);
var ChildNodeRe = __webpack_require__(36);
var Js_primitive = __webpack_require__(2);
var ParentNodeRe = __webpack_require__(8);
var EventTargetRe = __webpack_require__(4);
var NonDocumentTypeChildNodeRe = __webpack_require__(37);
...
function create(snake, food, direction) {
  return /* record */[
          /* canvasContext */0,
          /* snake */snake,
          /* food */food,
...
var $$Array = __webpack_require__(44);
var Curry = __webpack_require__(1);
var Int32 = __webpack_require__(46);
var Int64 = __webpack_require__(47);
var Digest = __webpack_require__(48);
var Caml_sys = __webpack_require__(27);
var Nativeint = __webpack_require__(52);
var Caml_array = __webpack_require__(20);
var Caml_int64 = __webpack_require__(29);
var Caml_string = __webpack_require__(30);
var Caml_builtin_exceptions = __webpack_require__(0);
...
var Curry = __webpack_require__(1);
var Js_exn = __webpack_require__(45);
var Caml_array = __webpack_require__(20);
var Caml_exceptions = __webpack_require__(31);
var Caml_builtin_exceptions = __webpack_require__(0);
...
var Char = __webpack_require__(42);
var $$String = __webpack_require__(49);
var Caml_md5 = __webpack_require__(51);
var Pervasives = __webpack_require__(13);
var Caml_string = __webpack_require__(30);
var Caml_missing_polyfill = __webpack_require__(32);
var Caml_builtin_exceptions = __webpack_require__(0);
